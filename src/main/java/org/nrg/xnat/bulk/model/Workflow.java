...
public class Workflow {
    ...
    public Workflow() {};
    public Workflow(Integer wfid, String id, String externalId, String pipelineName, String dataType, String comments,
    ...
    public void setProperty(String propertyName, Object propertyValue, Class propertyClass) {
        Method method;
        String methodName = propertyName.length() == 0 ? propertyName : "set" + propertyName.substring(0, 1).toUpperCase() + propertyName.substring(1);
        try {
